...
import { Ruler, Droplet, Layers, Paintbrush, Info, Wallet, ArrowRight, ShieldCheck, Package, Stethoscope, CheckCircle2, AlertTriangle, XCircle } from "lucide-react";

type ToolKey = "budget" | "diagnostic" | "fournitures" | "surface" | "colle" | "souscouche" | "vitrification";
...
const tools: { key: ToolKey; label: string; icon: typeof Ruler; subtitle: string }[] = [
  ...
  { key: "diagnostic", label: "Ponçage ou remplacement ?", icon: Stethoscope, subtitle: "Diagnostic personnalisé en 4 questions" },
    ...
    <section id="outils" className="scroll-mt-24 border-y border-border bg-secondary/40 py-24 sm:py-28">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-6 rounded-3xl border border-border bg-card p-6 shadow-soft sm:p-8">
          ...
          {active === "diagnostic" && <DiagnosticTool />}
