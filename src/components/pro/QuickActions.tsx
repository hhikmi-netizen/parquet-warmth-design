...
import { FileText, MessageSquare, CalendarDays, Camera, Inbox, ArrowRight } from "lucide-react";
...
const ACTIONS = [
  ...
  { id: "chantiers", label: "Photos chantier", icon: Camera, to: "/pro/chantiers" as const },
