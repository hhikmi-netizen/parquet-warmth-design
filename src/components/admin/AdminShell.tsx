    ...
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-background text-foreground">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          {/* Topbar */}
          <header className="sticky top-0 z-20 flex h-14 items-center gap-3 border-b border-border bg-card/80 px-3 backdrop-blur sm:px-6">
            <SidebarTrigger className="-ml-1" />
            <div className="hidden flex-1 items-center gap-2 rounded-full border border-border bg-background px-3 py-1.5 text-sm text-muted-foreground sm:flex sm:max-w-md">
            ...
            <div className="flex flex-1 items-center justify-end gap-2 sm:flex-none">
              ...
              <span className="inline-flex h-9 items-center gap-2 rounded-full border border-border bg-background px-3 text-xs">
          ...
          {/* Page header */}
          <div className="border-b border-border bg-background px-4 py-6 sm:px-8">
